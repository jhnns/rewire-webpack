...
describe("module replacement", function() {
	it("should be able to require the module without rewire", function() {
		require("rewire/test/testModules/moduleA").should.not.have.property("__get__");
	});
});
...
describe("__get__ & __set__", function() {
	...
	before(function() {
		...
		moduleA = rewire("rewire/test/testModules/moduleA");
	})
...
describe("rewire module loader", function() {
	it("should return different modules", function() {
		var rewire = require("rewire");
		var mA1 = rewire("rewire/test/testModules/moduleA");
		var mA2 = rewire("rewire/test/testModules/moduleA");
